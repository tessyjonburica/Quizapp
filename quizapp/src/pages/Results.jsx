...
function Results() {
    ...
    const { topic, score, totalQuestions } = location.state || { topic: "", score: 0, totalQuestions: 0 };

    return (
        <div className="min-h-screen bg-white dark:bg-gray-900 text-black dark:text-white transition-colors duration-300">
            <Header topic={topic} />
            <div className="mt-20 px-4 md:px-28 container mx-auto flex flex-col md:flex-row justify-between">
                <div className=" mb-6 md:mb-0 p-4 md:p-0">
                    <h2 className="text-3xl md:text-5xl text-gray-800 dark:text-white">Quiz Completed</h2>
